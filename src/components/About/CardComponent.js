    ...
    return (
        <div className={`tw-shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] tw-rounded-md tw-flex tw-flex-col ${isReversed ? 'sm:tw-flex-row-reverse' : 'sm:tw-flex-row'} tw-gap-12 tw-w-full sm:tw-w-3/4 tw-items-center tw-p-8`}>
          ...
          <div className="tw-relative content tw-w-full sm:tw-w-1/2">
            ...
            <blockquotes>
              <img src={Quote} className='tw-absolute tw-top-10 tw-z-30 tw-left-0 tw-w-10 tw-h-10' alt="quote" />
              <img src={Quote} className={`tw-rotate-180 tw-absolute tw-z-30 tw-w-10 tw-h-10 tw-bottom-4 tw-right-0 ${isReversed ? 'sm:tw-bottom-4 sm:tw-left-24' : 'sm:tw-right-20 sm:tw-bottom-4'} `} alt="quote" />
            </blockquotes>
          </div>
        </div>
      );
